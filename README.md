...
- If you want to use QwQ-32B on Windows, please use ollama or llama.cpp to deploy QwQ-32B locally first. and then connect the local LLM server by customized api.
